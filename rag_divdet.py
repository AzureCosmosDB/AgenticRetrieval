...
def _is_timing() -> bool:
    """Return whether timing/debug output is currently enabled."""
    return _TIMING
...
# Import placed here (after LLMClient and shared utilities) to satisfy the
# circular dependency: cosmos_retriever imports CONFIG, LLMClient, etc. from
# this module, so those definitions must exist before the import is executed.
